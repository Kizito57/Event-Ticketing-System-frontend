...
const EventBrowsing = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[400px] flex items-center justify-center" data-test="loading-indicator">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8" data-test="event-browsing-page">
      {/* Header */}
      ...
      {/* Error Alert */}
      {error && (
        <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-8 rounded-r-lg" data-test="error-message">
          <div className="flex">
            <div className="ml-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {availableEvents.map(event => (
          <div
            ...
            data-test={`event-card-${event.event_id}`}
          >
            <div className="relative h-56 overflow-hidden" data-test="event-image">
              {event.image_url ? (
                <img
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  data-test={`view-venue-${event.event_id}`}
                >
                ...
                <button
                  ...
                  data-test={`book-event-${event.event_id}`}
                >
                  Book Now
                </button>
              </div>
